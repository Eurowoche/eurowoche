...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.maerkte-slider-wrapper').forEach(function(wrapper) {
        ...
        // Lightbox für Märkte-Galerie
        var images = track.querySelectorAll('.maerkte-slider-item img');
        if (images.length > 0 && document.querySelector('.gallery-lightbox')) {
